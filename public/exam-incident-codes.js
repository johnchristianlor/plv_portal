...
export const INCIDENT_LABELS = Object.freeze({
  ...
  camera_unavailable: 'Required camera unavailable',
  camera_stopped: 'Required camera stopped',
  microphone_unavailable: 'Required microphone unavailable',
  microphone_stopped: 'Required microphone stopped',
  screen_share_unavailable: 'Required screen sharing unavailable',
  screen_share_stopped: 'Required screen sharing stopped',
